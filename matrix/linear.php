...
?>
<h1> CUDA - Linear System Solver </h1>
<body>
...
<div id="contact-form">
    ...
    <input type="hidden" name="process" value="matrix_linear"/>

    <h1 >Important : Output will be X column vector such that Ax=b where b is the input coefficient vector and A is the square coefficient matrix</h1>
