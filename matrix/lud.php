...
?>
<h1> CUDA - Matrix LU Decomposition </h1>
<body>
...
<input type="hidden" name="process" value="matrix_lud"/>

<h1 >Important : Output will be L and U such that A=LU</h1>
<h1>Matrix must be a square Matrix</h1>
